...
class AnimationDict:
    ...
    def has_key(self, key):
        return key in self.animations_dict

    def keys(self):
        return self.animations_dict.keys()

    def is_expired(self):
        return self.animation.is_expired()
...
class Animation:
    def __init__(self, frame_list, start_index=0, delay=100, is_loop=True):
    ...
    def is_expired(self):
        return not self.is_loop and self.index == len(self.frame_list) - 1
